// GENERATED AUTOMATICALLY FROM 'Assets/Julhiecio TPS Controller/Inputs/JUTPSInputControlls.inputactions'
...
{
    public class @JUTPSInputControlls : IInputActionCollection, IDisposable
    {
        ...
        public struct PlayerActions
        {
            ...
            public void SetCallbacks(IPlayerActions instance)
            {
                if (m_Wrapper.m_PlayerActionsCallbackInterface != null)
                {
                    ...
                    @Slot8.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot8;
                    @Slot8.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot8;
                    @Slot8.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot8;
                    @Slot9.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot9;
                    @Slot9.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot9;
                    @Slot9.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot9;
                    @Slot10.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot10;
                    @Slot10.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot10;
                    @Slot10.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSlot10;
                }
